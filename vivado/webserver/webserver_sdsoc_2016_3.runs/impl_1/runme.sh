...
HD_PWD='D:/GITHUB_EXTERNAL/webserver_sdsoc_2016_3/vivado/webserver/webserver_sdsoc_2016_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_soc_wrapper.tcl -notrace
