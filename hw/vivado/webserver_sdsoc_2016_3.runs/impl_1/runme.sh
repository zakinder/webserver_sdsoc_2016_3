...
HD_PWD='D:/OneDrive/GitHub/webserver_sdsoc_2016_3/hw/vivado/webserver_sdsoc_2016_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_accel_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sd_accel_wrapper.tcl -notrace
