...
HD_PWD='D:/OneDrive/GitHub/webserver_sdsoc_2016_3/hw/vivado/webserver_sdsoc_2016_3.runs/sd_accel_zed_audio_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd_accel_zed_audio_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sd_accel_zed_audio_ctrl_0_0.tcl
