...
HD_PWD='D:/OneDrive/GitHub/webserver_sdsoc_2016_3/hw/vivado/webserver_sdsoc_2016_3.runs/bd_4831_sys_reset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_4831_sys_reset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_4831_sys_reset_0.tcl
