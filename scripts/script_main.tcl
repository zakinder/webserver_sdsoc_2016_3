...
namespace eval ZQ {
  namespace eval INIT {
    ...
    proc show_help_batchfile_commands {} {
      ...
      puts ""
      puts "Example: vivado -source ../scripts/script_main.tcl  -mode batch -notrace -tclargs --part xc7z020clg484-1 --boardpart em.avnet.com:ZYNQ720-02-1cf:part0:1.3 --clean"
    }
    proc main {} {
      global argc
      global argv
