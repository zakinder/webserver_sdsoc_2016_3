...
//Command     : generate_target zed_audio_wrapper.bd
//Design      : zed_audio_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module zed_audio_wrapper
   (BCLK,
    DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  zed_audio zed_audio_i
       (.BCLK(BCLK),
        ...
        .GPIO2_tri_i({gpio2_tri_i_1,gpio2_tri_i_0}),
        .GPIO2_tri_o({gpio2_tri_o_1,gpio2_tri_o_0}),
        .GPIO2_tri_t({gpio2_tri_t_1,gpio2_tri_t_0}),
