...
#define SINE_WAVE XPAR_SINE_CTRL_SAXI_BASEADDR
...
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG0_OFFSET)&0x0000FFFF)|0x00010000;
} 
unsigned int READ_P2_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG1_OFFSET)&0x00007FFF)|0x00010000;
} 
unsigned int READ_P3_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG2_OFFSET)&0x00007FFF)|0x00010000;
} 
unsigned int READ_P4_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG3_OFFSET)&0x00007FFF)|0x00010000;
}
unsigned int READ_P5_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG4_OFFSET)&0x00007FFF)|0x00010000;
}
unsigned int READ_P6_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG5_OFFSET)&0x00007FFF)|0x00010000;
}
unsigned int READ_P7_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG6_OFFSET)&0x00007FFF)|0x00010000;
}
unsigned int READ_P8_SINE_WAVE()
{
	return (Xil_In32((SINE_WAVE) + SINE_ctrl_saxi_SLV_REG7_OFFSET)&0x00007FFF)|0x00010000;
}
...
int ch06(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch06 =  interrupt->ch06;
}
int ch07(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch07 =  interrupt->ch07;
}
int ch08(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch08 =  interrupt->ch08;
}
int ch09(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch09 =  interrupt->ch09;
}
int ch10(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch10 =  interrupt->ch10;
}
int ch11(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch11 =  interrupt->ch11;
}
int ch12(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch12 =  interrupt->ch12;
}
int ch13(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch13 =  interrupt->ch13;
}
int ch14(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch14 =  interrupt->ch14;
}
int ch15(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch15 =  interrupt->ch15;
}
int ch16(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch16 =  interrupt->ch16;
}
int ch17(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch17 =  interrupt->ch17;
}
int ch18(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch18 =  interrupt->ch18;
}
int ch19(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch19 =  interrupt->ch19;
}
int ch20(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch20 =  interrupt->ch20;
}
int ch21(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch21 =  interrupt->ch21;
}
int ch22(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch22 =  interrupt->ch22;
}
int ch23(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch23 =  interrupt->ch23;
}
int ch24(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch24 =  interrupt->ch24;
}
int ch25(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch25 =  interrupt->ch25;
}
int ch26(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch26 =  interrupt->ch26;
}
int ch27(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch27 =  interrupt->ch27;
}
int ch28(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch28 =  interrupt->ch28;
}
int ch29(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch29 =  interrupt->ch29;
}
int ch30(channel *ch_ptr,plregisters *interrupt)
{
	return ch_ptr->ch30 =  interrupt->ch30;
}
int ch31(channel *ch_ptr,plregisters *interrupt)
{
