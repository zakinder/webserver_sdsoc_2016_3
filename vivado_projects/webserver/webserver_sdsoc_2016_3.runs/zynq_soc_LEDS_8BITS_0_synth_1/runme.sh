...
HD_PWD='D:/GITHUB_EXTERNAL/webserver_sdsoc_2016_3/vivado/webserver/webserver_sdsoc_2016_3.runs/zynq_soc_LEDS_8BITS_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_LEDS_8BITS_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_soc_LEDS_8BITS_0.tcl
