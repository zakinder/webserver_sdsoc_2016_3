...
HD_PWD='C:/Sim/2016_3_zed_source/lab7/zed_audio/hw/vivado/zed_audio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_audio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zed_audio_wrapper.tcl -notrace
