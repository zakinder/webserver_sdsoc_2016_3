...
HD_PWD='C:/Sim/2016_3_zed_source/lab7/zed_audio/hw/vivado/zed_audio.runs/zed_audio_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_audio_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zed_audio_rst_ps7_0_100M_0.tcl
