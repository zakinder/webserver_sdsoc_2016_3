...
#
# Generated by export_simulation on Wed May 10 23:11:46 -0500 2017
#
################################################################################
...
switch to the './zed_audio.sh' script.

./zed_audio.sh -reset_run
...
./zed_audio.sh -noclean_files

For more information on the script, please type './zed_audio.sh -help'.
