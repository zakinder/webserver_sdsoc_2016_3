...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "Threshold" -parent ${Page_0} -text {Threshold Value}
  ipgui::add_static_text $IPINST -name "depth_c" -parent ${Page_0} -text {Depth : Number of samples in one period of the signal (2^8=256). Range 1 to 99.}
  ipgui::add_param $IPINST -name "depth_g" -parent ${Page_0}
  ipgui::add_static_text $IPINST -name "width_c" -parent ${Page_0} -text {Width : Number of bits used to represent amplitude value (2^12=4096). Range 1 to 99.}
